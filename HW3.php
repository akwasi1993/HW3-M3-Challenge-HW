...
<head>
    ...
    <style>
    nav {
  display: flex; /* (1 pt) Make the navigation horizontal */
  background-color: yellow; /* (1 pt) Give the navigation a background */
  list-style-type: none; /* (1 pt) Get rid of the navigation list item markers */
  padding: 0;
}
